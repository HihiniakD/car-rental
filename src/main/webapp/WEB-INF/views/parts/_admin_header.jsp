...
<header class="p-3 bg-dark text-white">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="${Path.ADMIN_PAGE_PATH}" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="${Path.ADMIN_PAGE_PATH}" class="nav-link px-2 text-white"><fmt:message key="adminPage"/></a></li>
            </ul>
